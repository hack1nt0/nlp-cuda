...
/*
!  Content:
!    Use of Intel MKL Sobol QRNG with direction numbers designed
...
int main(int argc, char *argv[])
{
    ...
    {
        printf("\nNumerical integration results are agreed with theory\n");
    }
    else
    {
        printf("\nError: Numerical integration results are not agreed with theory\n");
        status = 1;
    }
