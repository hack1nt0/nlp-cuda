...
#define INDIA 12
        ...
        MKL_Complex16    Acsc_standard[NZMAX]      =  {5.0, 1.0, 9.0, 1.0, 8.0, 1.0, 2.0, 1.0, 3.0, 1.0,
			                                      1.0, 1.0, 6.0, 1.0, 4.0, 1.0};
        MKL_Complex16    Adia[INDIA];
        MKL_Complex16    Adia_standard[INDIA]      =  {0.0, 0.0, 9.0, 1.0, 0.0, 0.0, 1.0, 1.0,
		                                      5.0, 1.0, 2.0, 1.0, 3.0, 1.0, 4.0, 1.0,
						     8.0, 1.0, 0.0, 0.0, 6.0, 1.0, 0.0, 0.0};
...
//***************************************************************************************************
       ...
       job[0] = 0;
       job[5] = 0;
       mkl_zcsrdia(job,&n,Acsr,AJ,AI,Adia,&ndiag,distance,&idiag,
		          Acsr,AJ,AI,&info);
